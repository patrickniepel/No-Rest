...
class IconSelectionViewController: UIViewController {
    ...
    private func setupView() {
        ...
        iconSelectionView.anchor(top: view.safeAreaLayoutGuide.topAnchor, centerX: view.centerXAnchor, padding: .init(top: NRStyle.verticalPadding * 2, left: 0, bottom: 0, right: 0), size: .init(width: width, height: height))
