...
class WorkoutSetupTableViewCell: NRTableViewCell {
    ...
    private func setupView() {
        ...
        nameLabel.anchor(leading: exerciseImageView.trailingAnchor, trailing: contentView.trailingAnchor, centerY: contentView.centerYAnchor, padding: .init(top: 0, left: NRStyle.verticalPadding / 2, bottom: 0, right: NRStyle.horizontalPadding))
    }
}
