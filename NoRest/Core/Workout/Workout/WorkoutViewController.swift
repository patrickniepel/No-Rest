...
class WorkoutViewController: NRViewController {
    ...
    private func setupView() {
        ...
        tableView.anchor(top: nameTextField.bottomAnchor, leading: view.leadingAnchor, trailing: view.trailingAnchor, padding: .init(top: NRStyle.verticalPadding, left: 0, bottom: 0, right: 0))
        selectExercisesButton.anchor(top: tableView.bottomAnchor, leading: view.leadingAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, trailing: view.trailingAnchor, padding: .init(top: NRStyle.verticalPadding, left: NRStyle.horizontalPadding * 2, bottom: NRStyle.verticalPadding, right: NRStyle.horizontalPadding * 2), size: .init(width: 0, height: 50))
    }
