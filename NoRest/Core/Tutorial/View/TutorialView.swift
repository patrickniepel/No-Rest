...
class TutorialView: UIView {
    ...
    private func addFinishButton() {
        ...
        finishButton.anchor(top: pageControl.bottomAnchor,
                            leading: leadingAnchor,
                            bottom: safeAreaLayoutGuide.bottomAnchor,
                            trailing: trailingAnchor,
                            padding: .init(top: 0, left: NRStyle.horizontalPadding * 2, bottom: NRStyle.verticalPadding, right: NRStyle.horizontalPadding * 3),
